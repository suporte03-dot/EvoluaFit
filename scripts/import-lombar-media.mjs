/**
 * Copia imagens de Lombar para public/media/exercises/lombar/
 */
...
const outDir = join(root, 'public/media/exercises/lombar')
mkdirSync(outDir, { recursive: true })

const INCLUDE = /images_(Superman|Hiperextens|Extens_o_[Ll]ombar|Extensao_[Ll]ombar)/i

const accentFixes = [
  [/hiperextens.o/gi, 'hiperextensao'],
...
if (!files.length) {
  console.error('Nenhuma imagem de Lombar em', assetsDir)
  process.exit(1)
}
...
for (const file of files) {
  ...
  map[finalSlug] = `media/exercises/lombar/${finalSlug}.png`
