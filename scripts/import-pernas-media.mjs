/**
 * Copia imagens de Pernas (Agachamento/Afundo/Avanço/Adução) para public/media/exercises/pernas/
 */
...
const outDir = join(root, 'public/media/exercises/pernas')
mkdirSync(outDir, { recursive: true })

const INCLUDE = /images_(Agachamento|Afundo|Avan_o|Adu__o_do_Quadril)/i
...
if (!files.length) {
  console.error('Nenhuma imagem de Pernas em', assetsDir)
  process.exit(1)
}
...
for (const file of files) {
  ...
  map[finalSlug] = `media/exercises/pernas/${finalSlug}.png`
