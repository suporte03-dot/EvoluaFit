...
/** Conteúdo editorial demonstrativo — não representa notícias reais em tempo real. */
...
export const fanPanelCards = [
  {
    id: 1,
    title: 'Jogos hoje',
    detail: 'Eventos demonstrativos no calendário',
    icon: '⚽',
    accent: 'green',
  },
  {
  ...
  },
  {
    ...
    detail: 'Final ilustrativa no cenário demo',
    icon: '⭐',
    accent: 'orange',
  },
  {
    ...
    detail: 'Agenda ilustrativa da semana',
    icon: '📅',
    accent: 'green',
  },
]
...
export const mainHeadline = {
  ...
  category: 'Futebol',
  filter: 'futebol',
  title: 'Cenário ilustrativo: clássico nacional movimenta a rodada demo',
  excerpt:
    'Matéria demonstrativa sobre rivalidade e pressão em partida fictícia do módulo de notícias.',
  fullContent: [
    'Esta é uma notícia ilustrativa criada para demonstrar a experiência editorial da Arena 360.',
    'O confronto, elencos e contexto não correspondem a jogos reais — consulte fontes oficiais para cobertura atual.',
    'O layout destaca título, resumo e leitura expandida como em um portal esportivo completo.',
  ],
  date: '10 Jul 2026',
  readTime: '6 min',
  tag: 'Demonstrativo',
...
export const gridNews = [
  {
    ...
    filter: 'brasileirao',
    title: 'Rodada 15 do Brasileirão — cenário demonstrativo no topo',
    excerpt: 'Classificação ilustrativa com Flamengo, Palmeiras e Botafogo em destaque fictício.',
    fullContent: [
      'Matéria demonstrativa da 15ª rodada do Campeonato Brasileiro com confrontos fictícios.',
      'Os jogos e posições não refletem a tabela oficial — consulte a CBF para dados reais.',
    ],
    date: '11 Jul 2026',
    readTime: '5 min',
  ...
  },
  {
    ...
    category: 'Brasileirão',
    filter: 'brasileirao',
    title: 'Artilharia ilustrativa do Brasileirão — cenário demo',
    excerpt: 'Atacante fictício lidera disputa demonstrativa de gols na temporada 2026.',
    fullContent: [
      'Conteúdo ilustrativo sobre artilharia do campeonato — nomes e números são fictícios.',
      'Serve para demonstrar como estatísticas individuais seriam apresentadas no portal.',
    ],
    date: '10 Jul 2026',
    readTime: '3 min',
  ...
  },
  {
    ...
    category: 'Fórmula 1',
    filter: 'formula1',
    title: 'F1 — treinos ilustrativos no GP da Grã-Bretanha (demo)',
    excerpt:
      'Cenário demonstrativo em Silverstone com disputa fictícia entre os principais nomes do grid.',
    fullContent: [
      'Silverstone recebe o GP da Grã-Bretanha — nomenclatura correta para o circuito britânico.',
      'Tempos e estratégias são ilustrativos; consulte a FIA para o calendário oficial da F1.',
    ],
    date: '09 Jul 2026',
    readTime: '3 min',
  ...
  },
  {
    ...
    category: 'Lutas',
    filter: 'lutas',
    title: 'Lutador brasileiro em cenário ilustrativo de cinturão (demo)',
    excerpt: 'Finalização fictícia em card demonstrativo de MMA internacional.',
    fullContent: [
      'Matéria ilustrativa sobre vitória em evento de lutas — não representa resultado real.',
      'Serve para demonstrar cobertura de MMA no módulo de notícias da Arena 360.',
    ],
    date: '09 Jul 2026',
    readTime: '5 min',
  ...
  },
  {
    ...
    category: 'Tênis',
    filter: 'tenis',
    title: 'Wimbledon — brasileira em cenário ilustrativo de quartas (demo)',
    excerpt: 'Campanha fictícia em Grand Slam de grama para demonstração do módulo de tênis.',
    fullContent: [
      'Conteúdo demonstrativo sobre tenista brasileira em fase avançada de torneio de Grand Slam.',
      'Resultados e ranking não correspondem a dados reais da ATP/WTA.',
    ],
    date: '08 Jul 2026',
    readTime: '3 min',
  ...
  },
  {
    ...
    category: 'Basquete',
    filter: 'basquete',
    title: 'NBA Summer League — estreia ilustrativa da seleção (demo)',
    excerpt: 'Vitória fictícia em torneio de verão para demonstração do módulo de basquete.',
    fullContent: [
      'Matéria demonstrativa sobre basquete em julho — período coerente com a Summer League, não com playoffs.',
      'Elencos e placares são ilustrativos e não representam jogos oficiais.',
    ],
    date: '08 Jul 2026',
    readTime: '4 min',
